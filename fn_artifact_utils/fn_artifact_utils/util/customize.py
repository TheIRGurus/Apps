...
def codegen_reload_data():
    ...
    return {
        ...
        "workflows": [u"example_artifact_utils_add_tags_based_on_artifact_query", u"example_artifact_utils_delete_artifacts_based_on_query", u"example_artifact_utils_remove_tags_based_on_artifact_query"],
        "actions": [u"Example: Artifact Utils: Add Tag(s) Based on Search", u"Example: Artifact Utils: Delete Artifacts", u"Example: Artifact Utils: Remove Tag(s) Based on Search"],
        "incident_fields": [],
