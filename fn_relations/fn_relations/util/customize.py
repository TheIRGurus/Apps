...
def codegen_reload_data():
    ...
    return {
        ...
        "functions": [u"relations_assign_parent", u"relations_auto_close_child_incidents", u"relations_remove_child_relation", u"relations_sync_child_table_data", u"relations_sync_notes"],
        "workflows": [u"example_relations_assign_parent", u"example_relations_auto_close_child_incidents", u"example_relations_remove_child_relation", u"example_relations_sync_notes_to_parentchild", u"example_relations_update_child_table_data"],
        "actions": [u"Example: Relations - Assign Parent Incident", u"Example: Relations - Close Child Incidents", u"Example: Relations - Remove Child Relation", u"Example: Relations - Sync Notes with Child", u"Example: Relations - Sync Notes with Parent", u"Example: Relations - Update Child Incident Parent Data Table"],
